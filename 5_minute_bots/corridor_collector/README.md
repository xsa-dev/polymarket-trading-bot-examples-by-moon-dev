...
* Sweet zone (15m lead of 5 to 30 bps AND lead/ATR14 ≥ 1.0): the double-win corridor hit
  **41.3%** (n=18,649) → fair pair value ≈ **$1.41**.
* The 5m-opposite leg is a true coin flip (49.7 to 50.1% across every lead bin), buying it
...
* Zone gate: 15m lead between 5 to 30 bps and lead/ATR14 ≥ 1.0 (leads too small flip, leads
