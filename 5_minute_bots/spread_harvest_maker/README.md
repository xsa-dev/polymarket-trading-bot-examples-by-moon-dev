...
asks add up to $1.10 or more, leaving a 10–20 cent hole in the middle of a genuine
...
- The **stink-bid signal bots** bid cheap (≤ 0.35): fills won **32–35%** — a resting bid
...
- But the **mid-price** fills told a different story: the 0.40–0.50 band went **12/21 =
  57% win at a 44c average** — NOT toxic. And my June dog-scanner logged **17 windows in
  one week** where the dog ask sat at 0.60–0.68 in near-tie windows — the wide books are
...
cancel. Full numbers in [RESEARCH.md](RESEARCH.md).
...
- **Quote:** dog-side best_bid + $0.01, hard band **0.40–0.48**, strictly below the dog
