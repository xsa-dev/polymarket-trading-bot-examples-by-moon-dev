...
often still prices the cascade side at only 50 to 85 cents. This bot buys that side at
...
* Price IS the filter: only enter at **0.50 to 0.85**. Below 0.50 the market disagrees with
  the liq, historically that loses. Above 0.85 the fee eats the edge (and buying late
  favorites is a proven loser).
* **Minutes 0 to 3 only.** No stink bids, ever. Unfilled after 5 seconds → cancel and skip.
